...
module Manager
  class SupportsController < ApplicationController
    before_action :set_support, only: [:show, :edit, :update, :destroy, :calculate_score, :recalculate_matches, :assign_caregiver]
    ...
    def edit
      @caregivers = Caregiver.all.sort_by { |c| -c.match_score(@support) }
    end
    ...
    def update
      if @support.update(support_params)
        redirect_to manager_dashboard_path, notice: 'Support was successfully updated.'
      else
        render :edit
      end
    end
